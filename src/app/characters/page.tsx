  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-16">
      ...
      <p className="mt-1 text-sm text-muted-foreground">
        Mains are computed automatically from your actual match history. Most echo fighters
        (Dark Pit, Daisy, Dark Samus, Richter) are counted together with their base fighter —
        Marth/Lucina, Roy/Chrom, and Ryu/Ken are kept separate. Browse a character&apos;s
        leaderboard below.
      </p>
